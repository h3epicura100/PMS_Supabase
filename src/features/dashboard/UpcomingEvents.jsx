                ...
                >
                  ...
                  <div className="flex items-start justify-between gap-2 border-b border-slate-100 pb-2.5">
                    ...
                    <div className="text-right">
                      <span className="text-[10px] uppercase font-semibold text-slate-400 block">Guests</span>
                      <span className="font-mono font-bold text-slate-800 text-xs">{paxDisplay}</span>
                    </div>
                  </div>
                  ...
                  <div className="space-y-1 pt-1">
                    <div className="flex items-center justify-between text-[11px]">
                      ...
                      <span className="font-medium text-pms-muted font-mono">{info.pct}% ({info.done}/{info.total})</span>
                    </div>
