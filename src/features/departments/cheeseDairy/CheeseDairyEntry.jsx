  ...
  return (
    <div className="bg-slate-50/80 border border-slate-200 rounded-2xl p-4.5 space-y-4 shadow-sm relative transition-all border-l-4 border-l-pms-accent hover:border-slate-300">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
        ...
        {/* 3. Status Selector */}
        <div className={`space-y-1.5 ${itemType === 'Normal' ? 'sm:col-span-1' : 'sm:col-span-2'}`}>
          <label className="text-xs font-semibold text-slate-700 block">
      ...
      <Textarea
        ...
        placeholder="Cheese/dairy product name, brand, weight or special storage instructions..."
        value={entry.remarks || ''}
